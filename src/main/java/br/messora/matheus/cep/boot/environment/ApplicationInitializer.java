package br.messora.matheus.cep.boot.environment;
...
@EnableJpaRepositories({"br.messora.matheus.cep.infrastructure.repository"})
@EnableWebMvc
public class ApplicationInitializer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("br.messora.matheus.cep.infrastructure.repository");
