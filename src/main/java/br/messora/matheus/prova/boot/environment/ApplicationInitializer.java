package br.messora.matheus.prova.boot.environment;
...
@Configuration
@ComponentScan("br.messora.matheus.prova")
@EnableJpaRepositories({"br.messora.matheus.prova.infrastructure.repository"})
@EnableWebMvc
